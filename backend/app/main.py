...
from app.api.routes import analyze, audit, documents, eval, generate_from_analysis, health, projects, requirements, review, templates, uploads
...
def create_app() -> FastAPI:
    ...
    for router in (health, templates, projects, uploads, requirements, documents, review, eval, audit, analyze, generate_from_analysis):
